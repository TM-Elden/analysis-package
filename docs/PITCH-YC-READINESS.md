# YC pitch readiness rubric - fathm

**Scored:** 2026-08-16  
**Scale:** 0–5 per row (0 missing · 3 usable · 5 partner-ready)  
**Bar for "YC-ready deck artifact":** average ≥ 3.5 and no row at 0 on deck-controllable items.  
**Bar for "ready to submit/raise":** average ≥ 4.0 including traction/demo reality.
...
|---|-----------|------:|-------|
| 1 | One-liner (partner can repeat) | **4** | Brand + category line locked in spine |
| 2 | Problem crisp + painful | **5** | Bot sprawl + un-auditable AI analysis - sharp |
| 3 | Solution crisp (not 12 features) | **4** | Package + gate + chart room - tight enough |
| 4 | Why now | **4** | Agents live; CI on publish unit; LLM query after structure |
...
## What moved this pass (agent-owned)
